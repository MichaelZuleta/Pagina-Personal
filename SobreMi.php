...
<body>
    ...
    <main>
        <h2>Sobre Mi</h2>
        <p>Mi nombre es Michael Zuleta, soy un Colombiano de 23 años (y contando). La cosa que más adoro en el mundo son los videojuegos,
             desde pequeño fuí expuesto a ese maravilloso y a veces incluso enriquecedor mundillo. Desde entonces esta pasión se ha convertido en una piedra 
